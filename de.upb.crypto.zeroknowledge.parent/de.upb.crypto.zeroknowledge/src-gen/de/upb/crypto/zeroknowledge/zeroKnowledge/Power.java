 ...
 * </ul>
 *
 * @see de.upb.crypto.zeroknowledge.zeroKnowledge.ZeroKnowledgePackage#getPower()
 * @model
 * @generated
 */
public interface Power extends Expression
{
   ...
   * @see de.upb.crypto.zeroknowledge.zeroKnowledge.ZeroKnowledgePackage#getPower_Left()
  ...
  /**
   * Sets the value of the '{@link de.upb.crypto.zeroknowledge.zeroKnowledge.Power#getLeft <em>Left</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.upb.crypto.zeroknowledge.zeroKnowledge.ZeroKnowledgePackage#getPower_Right()
   * @model containment="true"
   * @generated
   */
  Expression getRight();
  ...
  /**
   * Sets the value of the '{@link de.upb.crypto.zeroknowledge.zeroKnowledge.Power#getRight <em>Right</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
