 ...
 */
public class GroupInferenceProvider implements InferenceProvider<String, GroupType> {
    ...
    private Map<String, FunctionDefinition> userFunctions;

	public GroupInferenceProvider() {
        // Intentionally blank
    }

    @Override
    public Map<String, GroupType> infer(AugmentedModel augmentedModel) {
        groups = new HashMap<>();
